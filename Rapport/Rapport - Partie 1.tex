...
Doivent être exprimées en français ou anglais et utiliser les mêmes noms d'entités, d'associations ou d'attributs que dans le modèle conceptuel.

\subsection*{Remarques}
Exprimer et justi??fier des hypothèses sur le modèle

\section{Modèle Relationnel}
A déduire du modèle entité-association, traduction relationnelle du diagramme et de ses contraintes
